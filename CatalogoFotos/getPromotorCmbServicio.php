...
$sql = "select idpromotor,concat(nombre,' ',apellidos) as nombrecompleto from cat_promotor where idestatus=1 and idempresa = " . $condicion . " order by nombrecompleto asc;";
//echo($sql);
//echo ('<br>');
