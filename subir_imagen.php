...
$postdata["idproducto"] = $_POST["idproducto"]; //Obtiene idproducto
...
if(sizeof($request->imagen) == 0 && trim($request->ruta) == "" && (int)$request->idproducto > 0){
   return http_response_code(400);
    ...
    $sql = "update cat_productos set ruta = '" . $ruta_host .  "' where idproducto = '{$idproducto}';";       
