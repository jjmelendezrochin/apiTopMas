<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){		            
	        ...
	        // if (intval($Distancia_m)>=250 && $idpromotor!=2757)
			...
			$path1 = "fotos/" . $idfoto1 . "_" . $idusuario . "_[". $tienda . "]_" . str_replace(":", ".", $fechahora) . "_[" .  $idoperacion1 . "]_.png";
			$path2 = "fotos/" . $idfoto2 . "_" . $idusuario . "_[". $tienda . "]_" . str_replace(":", ".", $fechahora) . "_[" .  $idoperacion2 . "]_.png";			
