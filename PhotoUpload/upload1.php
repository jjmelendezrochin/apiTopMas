<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){		            
        ...
        /*
            if( 
            (intval($Distancia_m)>=250 && $idpromotor!=2757) ||
            (intval($Distancia_m)>=250 && $idpromotor!=2812) 
        )
        (intval($Distancia_m)>=250 && $idpromotor!=2757)
        */
        ...
        if($cta==0){
            ...
            if(mysqli_query($con,$sql)){
                    ...
                    $resultado =  "Imagen cargada corretamente";
                    // *******************************
    				// Inserción de datos			
    				$ins = " Insert into bitacora_fotos(idoperacion, idpromotor, idruta, FechaHora, instruccion) " .
                    " values (" .$idoperacion. "," .$idpromotor . "," .$idruta . ",CURRENT_TIMESTAMP,'" . $resultado . "');";
